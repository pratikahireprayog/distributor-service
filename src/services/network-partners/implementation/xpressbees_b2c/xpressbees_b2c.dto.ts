// Authentication DTOs
export class XpressbeesB2cAuthRequestDto {
  email: string;
  password: string;
}

export class XpressbeesB2cAuthResponseDto {
  status: boolean;
  data?: string; // Token is directly in data field as a string
}

// Product DTO
export class XpressbeesB2cProductDto {
  product_name: string;
  product_qty: string;
...
// Invoice DTO
export class XpressbeesB2cInvoiceDto {
...
export class XpressbeesB2cCreateOrderRequestDto {
  id: string;
  ...
  products: XpressbeesB2cProductDto[];
  invoice: XpressbeesB2cInvoiceDto[];
  weight: string;
  length: string;
  height: string;
  breadth: string;
...
export class XpressbeesB2cCreateOrderResponseDto {
  response?: boolean;
  status?: number;
  message?: string;
  shipping_id?: number;
...
export class XpressbeesB2cCancelOrderRequestDto {
  awb_number: string;
}

// Cancel Order Response DTO
export class XpressbeesB2cCancelOrderResponseDto {
  status: number;
  message: string;
  data?: any;
}
...
export class XpressbeesB2cCreateManifestRequestDto {
  awb_numbers: string;
}

// Create Manifest Response DTO
export class XpressbeesB2cCreateManifestResponseDto {
  status: boolean;
  message: string;
  data?: any;
}
